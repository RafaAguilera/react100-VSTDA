...
<label className="pt-3" for="floatingText">Edit Mode</label>
  <textarea className="form-control" placeholder="Comments..." id="floatingText" style={{height: "100px"}} name="taskedit" defaultValue={props.taskBody} onChange={()=>props.getText(props.id)}></textarea>
...
<button type="button" className="btn btn-success btn-lg mt-1 mb-3" onClick={()=>props.getEdit(props.id)}>Save</button>
...
<div className='col-1'>
  ...
  <p className="card-text col-9 text-wrap fs-6">{props.taskBody}</p>

<div className='col-2'>
<button type="button" className="btn btn-secondary" onClick={()=>props.getEdit(props.id)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-square" viewBox="0 0 16 16">
